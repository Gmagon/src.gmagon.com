...
If you want to implement the todo app with imperative programming, you will model each of the\_programmatic effects\_as an impure function. In pseudo code, it will look something like this:
